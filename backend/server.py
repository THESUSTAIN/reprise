...
# ── Vision Board — version SANS MongoDB (store fichier JSON local), branché en /api
import vision_local as _vision_local
app.include_router(_vision_local.vision_router, prefix="/api")
app.include_router(_vision_local.canva_router, prefix="/api")
