...
async def upload_file(file: UploadFile = File(...), user: User = Depends(get_current_user)):
    ...
    # Fix #89 — Read in chunks to reject oversized files without loading into RAM
    ...
    try:
        if ext == ".pdf":
            ...
            if _zf_upload.is_zipfile(filepath):
                ...
                with _zf_upload.ZipFile(filepath, "r") as zf:
        ...
        for fid in request.file_ids:
            ...
            for fname in os.listdir(UPLOADS_DIR):
                if fname.startswith(fid):
                    ...
                    logger.info(f"Found file for {fid}: {fpath} (ext={ext})")
                    if ext in [".png", ".jpg", ".jpeg", ".gif", ".webp"]:
                        ...
                        try:
                            ...
                            if text.strip():
                                ...
                                import base64 as b64_pdf
                                with open(fpath, "rb") as f:
                                    b64_data = b64_pdf.b64encode(f.read()).decode()
                        ...
                        try:
                            ...
                            if _zf.is_zipfile(fpath):
                                with _zf.ZipFile(fpath, "r") as zfr:
                                    znames = zfr.namelist()
            ...
            if mode == "byok":
                ...
                if not mammoth_key:
                    asyncio.ensure_future(log_event(
                        ...
                        action='chat_request', user_id=current_user.id, user_email=current_user.email,
                    ...
                    for _attempt in range(2):
                        ...
                        try:
                            ...
                            asyncio.ensure_future(log_event(
                                ...
                                action='mammoth_connect_error', user_id=current_user.id, user_email=current_user.email,
                        ...
                        try:
                            ...
                            if not _fb_enabled or not _fb_key:
                                asyncio.ensure_future(log_event(
                                    ...
                                    action='service_unavailable', user_id=current_user.id, user_email=current_user.email,
                                ...
                                if _alert_email:
                                    ...
                                    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
                                      ...
                                      <div style="background:#FEF2F2;border:1px solid #FECACA;padding:1.5rem;border-radius:0 0 8px 8px">
                                        ...
                                        <p><strong>Utilisateur :</strong> {current_user.email}</p>
