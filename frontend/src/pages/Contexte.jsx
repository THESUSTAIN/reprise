...
import ProspectionAgent from "./ProspectionAgent";
...
const TABS = [
  ...
  { id: "agents", label: "Agent Prospection", Icon: Bot },
];

function AgentsContext() {
  return (
    <div className="space-y-4" data-testid="contexte-agents">
      <div className="glass flex items-start gap-3 p-5">
        ...
        <p className="m-0 max-w-3xl text-[13px] leading-relaxed text-white/60">
          Un agent prépare, il n’engage rien. Celui-ci interroge des sources publiques, lit les sites
          qu’il trouve en respectant leur robots.txt, et vous rend des fiches scorées. Chaque message
          commercial part de votre relecture, jamais de sa seule décision.
        </p>
      </div>
      <ProspectionAgent />
    </div>
