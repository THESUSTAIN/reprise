...
function AppHome() {
  ...
  if (isMobile) {
    return (
      <div className="fixed inset-0 z-[150] overflow-hidden overscroll-none bg-[#102945]" data-testid="mobile-copilot-home">
        <ChatPanel
...
class AppErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#102945", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "Inter, system-ui, sans-serif" }}>
...
function RequireAuth() {
  ...
  if (etat === "verification") {
    return (
      <div style={{ minHeight: "100vh", background: "#102945", color: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14, fontFamily: "Inter, system-ui, sans-serif" }}>
